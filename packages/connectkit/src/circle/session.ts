 ...
 * hole leaks this token — the 60-minute expiry is what bounds the damage.
 */
...
/**
 * Circle mints 60-minute user tokens. We expire at 55 to avoid handing a token
 * to a challenge that will outlive it mid-flight.
 */
